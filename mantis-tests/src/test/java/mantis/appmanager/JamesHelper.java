...
public class JamesHelper {
    ...
    private List<MailMessage> getAllMail(String username, String password) throws MessagingException {
        Folder inbox = openInbox(username, password);
        List<MailMessage> messages = Arrays.stream(inbox.getMessages()).map((m) -> {
            try {
                return toModelMain(m);
    ...
    public static MailMessage toModelMain(Message m) throws MessagingException, IOException {
        try {
